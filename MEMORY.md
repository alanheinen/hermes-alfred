...
## Memory & Tracking
- **Daily logs:** Active practice — most recent file: `2026-03-18.md`
  - Older-than-7-day logs reviewed/distilled through `2026-03-11.md`: `2026-02-28.md` ✓, `2026-03-04.md` ✓, `2026-03-06.md` ✓, `2026-03-08.md` ✓, `2026-03-09.md` ✓, `2026-03-10.md` ✓, `2026-03-11.md` ✓
  - Mar 12-18 quant/admin updates are distilled below
...
- **Current default baseline (extended-history):** weekly MA150 inflation guard over the 1994-02-04 to 2026-03-17 sample
  - Latest rerun metrics (Mar 18): **12.59% CAGR / 0.75 Sharpe / -55.2% MaxDD / 72 trades**
...
## Recent Updates
- **March 18, 2026:** Recalibrated synthetic IEF/BIL proxy durations against ETF overlap, added `proxy_validation.csv` diagnostics, reran the full backtest stack, and pushed commit `c2b0852`. Current default metrics: 12.59% CAGR / 0.75 Sharpe / -55.2% MaxDD / 72 trades over 1994-02-04 to 2026-03-17.
